                    ...
                    <form action="../netting/islem.php" method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text"  name="menu_ad"  value="<?php echo $menucek['menu_ad']; ?>"required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
              ...
              <script type="text/javascript">
...

               {
                ...
                forcePasteAsPlainText: true
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text"  name="menu_url"  value="<?php echo $menucek['menu_url']; ?>"required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      	</div>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text"  name="menu_sira"  value="<?php echo $menucek['menu_sira']; ?>"required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
